              ...
              <div className="card">
                <div className="body">
                  <div className="d-flex align-items-center">
                    <div className={`icon-in-bg ${item.iconBgCLr} text-white rounded-circle`}>
                      <i className={item.icon}></i>
                    </div>
                    <div className="ml-4">
                      <span>{item.title}</span>
                      <h4 className="mb-0 font-weight-medium">{item.quantity}</h4>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="body">
              <div className="d-flex align-items-center">
                ...
                <div className="ml-4">
                  ...
                  <h4 className="mb-0 font-weight-medium">100</h4>
                </div>
              </div>
            </div>
          </div>
